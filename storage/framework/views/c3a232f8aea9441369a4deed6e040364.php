...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            <?php echo e(__('Universités Données de Tables')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                        <a href="<?php echo e(route('admin.universities.create')); ?>" class="btn btn-primary">Créer une Université</a>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-2 border"><?php echo e($university->id); ?></td>
                                <td class="px-4 py-2 border">
                                    <img src="<?php echo e(asset($university->picture)); ?>" alt="Logo de l'université" class="w-30 h-30">
                                </td>
                                <td class="px-4 py-2 border"><?php echo e($university->name); ?></td>
                                <td class="px-4 py-2 border"><?php echo e(\Illuminate\Support\Str::limit($university->description, 100, '...')); ?></td>
                                <td class="px-4 py-2 border"><?php echo e($university->location); ?></td>
                                <td class="px-4 py-2 border">
                                    <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
<?php endif; ?>
                                    <form action="<?php echo e(route('admin.universities.destroy', $university)); ?>" method="POST"
                                        class="inline-block">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\adral\Desktop\UniversityRatingTogo\resources\views/universities/list.blade.php ENDPATH**/ ?>