...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Authentification à deux facteurs')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Ajoutez une sécurité supplémentaire à votre compte à l\’aide de l\’authentification à deux facteurs.')); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <h3 class="text-lg font-medium text-gray-900">
            <!--[if BLOCK]><![endif]--><?php if($this->enabled): ?>
                <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                    <?php echo e(__('Terminer l\’activation de l\’authentification à deux facteurs.')); ?>

                <?php else: ?>
                    <?php echo e(__('Vous avez activé l\’authentification à deux facteurs.')); ?>

                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <?php else: ?>
                <?php echo e(__('Vous n\’avez pas activé l\’authentification à deux facteurs.')); ?>
        ...
        <div class="max-w-xl mt-3 text-sm text-gray-600">
            <p>
                <?php echo e(__('Lorsque l\’authentification à deux facteurs est activée, vous êtes invité à saisir un jeton aléatoire sécurisé lors de l\’authentification. Vous pouvez récupérer ce jeton à partir de l\’application Google Authenticator de votre téléphone.')); ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showingQrCode): ?>
                <div class="max-w-xl mt-4 text-sm text-gray-600">
                    <p class="font-semibold">
                        <!--[if BLOCK]><![endif]--><?php if($showingConfirmation): ?>
                            <?php echo e(__('Pour terminer l\’activation de l\’authentification à deux facteurs, scannez le code QR suivant à l\’aide de l\’application d\’authentification de votre téléphone ou entrez la clé de configuration et fournissez le code OTP généré.')); ?>

                        <?php else: ?>
                            <?php echo e(__('L’authentification à deux facteurs est désormais activée. Scannez le code QR suivant à l’aide de l’application d’authentification de votre téléphone ou entrez la clé de configuration.')); ?>
                ...
                <div class="max-w-xl mt-4 text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('Clé de configuration')); ?>: <?php echo e(decrypt($this->user->two_factor_secret)); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'code','type' => 'text','name' => 'code','class' => 'block w-1/2 mt-1','inputmode' => 'numeric','autofocus' => true,'autocomplete' => 'one-time-code','wire:model' => 'code','wire:keydown.enter' => 'confirmTwoFactorAuthentication']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($showingRecoveryCodes): ?>
                <div class="max-w-xl mt-4 text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('Stockez ces codes de récupération dans un gestionnaire de mots de passe sécurisé. Ils peuvent être utilisés pour récupérer l\’accès à votre compte en cas de perte de votre dispositif d\’authentification à deux facteurs.')); ?>
...
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('Régénérer les codes de récupération')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-3']); ?>
                            <?php echo e(__('Afficher les codes de récupération')); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\adral\Desktop\UniversityRatingTogo\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>