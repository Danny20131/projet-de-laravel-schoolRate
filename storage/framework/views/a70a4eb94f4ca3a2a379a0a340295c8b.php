...
<?php endif; ?>
            ...
            <div>
                ...
                <a href="<?php echo e(url('/dashboard')); ?>" class="px-4 text-sm font-semibold text-gray-600 hover:text-gray-900">Tableau de bord</a>
                <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="px-4 text-sm font-semibold text-gray-600 hover:text-gray-900">se connecter</a>
                <?php if(Route::has('register')): ?>
                <a href="<?php echo e(route('register')); ?>" class="px-4 text-sm font-semibold text-gray-600 hover:text-gray-900">s'inscrire</a>
                <?php endif; ?>
                <?php endif; ?>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\adral\Desktop\UniversityRatingTogo\resources\views/welcome.blade.php ENDPATH**/ ?>