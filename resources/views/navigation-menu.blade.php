    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('admin.universities.dataTable') }}" :active="request()->routeIs('admin.universities.dataTable')">
                        {{ __('Universites') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('admin.criteres.index') }}" :active="request()->routeIs('admin.criteres.index')">
                        {{ __('Critères') }}
                    </x-nav-link>
                </div>
                ...
                @else
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('universities.rankings') }}" :active="request()->routeIs('universities.rankings')">
                        {{ __('Classement') }}
                    </x-nav-link>
                </div>
                @endif
