<x-action-section>
    ...
    <x-slot name="description">
        {{ __('Ajoutez une sécurité supplémentaire à votre compte à l\’aide de l\’authentification à deux facteurs.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="max-w-xl mt-3 text-sm text-gray-600">
            <p>
                {{ __('Lorsque l\’authentification à deux facteurs est activée, vous êtes invité à saisir un jeton aléatoire sécurisé lors de l\’authentification. Vous pouvez récupérer ce jeton à partir de l\’application Google Authenticator de votre téléphone.') }}
            </p>
        </div>
            ...
            @if ($showingQrCode)
                <div class="max-w-xl mt-4 text-sm text-gray-600">
                    <p class="font-semibold">
                        ...
                        @else
                            {{ __('L’authentification à deux facteurs est désormais activée. Scannez le code QR suivant à l’aide de l’application d’authentification de votre téléphone ou entrez la clé de configuration.') }}
                        @endif
                    </p>
                </div>
